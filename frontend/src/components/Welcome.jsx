  ...
  return (
    <Paper shadow="md" p="xl" pt={0} withBorder maw={600}>
      ...
      <Alert color="orange" title="Important">
        <Text>
          On the first visit you are assigned a unique ID that will be used to keep the association
          between you and the links you create and provide access to your history and statistics.
        </Text>
        <br />
        <Text>
          Your unique ID:&nbsp;
